...
1. CodeBook.md file, describing the variables and data
...
The original data needs to be downloaded and unzipped into the working directory. 

2. Run_Analysis.R, R script required in the description of the project which does:
